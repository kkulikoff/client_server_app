...
handler = logging.handlers.TimedRotatingFileHandler('logs/server.log', encoding='utf-8', interval=1, when='D')
logger.addHandler(handler)
fh.setLevel(logging.DEBUG)
fh.setFormatter(formatter)

# Создаем файловый обработчик логирования для функций клиента и сервера general_func
fh_func = logging.FileHandler('logs/general_func.log', encoding='utf-8')
