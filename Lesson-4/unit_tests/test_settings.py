...
from collective.settings import RESPONSE, ERROR, USER, ACCOUNT_NAME, TIME, ACTION, PRESENCE, ENCODING
...
class TestSocket:
    ...
    def send(self, message_to_send):
        ...
        """
        json_test_message = json.dumps(self.test_dict)  # Кодирует сообщение
        self.encoded_message = json_test_message.encode(ENCODING)  # Сохраняем что должно быть отправлено в сокет
...
class TestUtils(unittest.TestCase):
    """
    Еестовый класс, выполняющий тестирование
    """
    test_dict_send = {
        ACTION: PRESENCE,
        TIME: 111111.111111,
    ...
    def test_send_message(self):
        ...
        создадиим тестовый сокет и проверим корректность отправки словаря
        """
